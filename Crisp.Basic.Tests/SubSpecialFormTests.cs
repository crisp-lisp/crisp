...
{
    [TestClass]
    public class SubSpecialFormTests
    {
        ...
        [TestMethod]
        public void SubSpecialFormShouldProduceCorrectTotal()
        {
            /**
             * Description: The sub special form should return a numeric atom that contains
             * the difference of two given numeric atoms as its value. This test ensures that this is
             * the case.
             */
        ...
        [TestMethod]
        public void SubSpecialFormShouldTakeCorrectNumberOfParameters()
        {
            /**
